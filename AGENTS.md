...
## Zero-context Nexus rule

Assume Nexus knows nothing about this repository when it enters.

Therefore, start from the roadmap and data-contract discovery path before implementation code.
