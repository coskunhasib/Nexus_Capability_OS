...
import { Activity, AlertTriangle, BarChart3, CheckCircle2, CircleDot, Database, ShieldCheck } from 'lucide-react';
...
export default function RegistryGovernance() {
  const [tab, setTab] = useState<'issues' | 'orphan' | 'health' | 'usage'>('issues');
