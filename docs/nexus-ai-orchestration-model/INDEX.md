...
1. [`00-decision-log.md`](./legacy/00-decision-log.md) — locked decisions D-001..D-010 + D-016
2. [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) — locked decisions D-011..D-015
3. [`01-nexus-ai-operating-model.md`](./01-nexus-ai-operating-model.md)
4. [`02-concept-boundaries.md`](./legacy/02-concept-boundaries.md)
5. [`03-governance-and-audit-layering.md`](./legacy/03-governance-and-audit-layering.md)
6. [`04-open-discussion-items.md`](./legacy/04-open-discussion-items.md)
7. [`04a-open-discussion-updates.md`](./legacy/04a-open-discussion-updates.md)
8. [`05-shared-registry-and-usage-mapping.md`](./legacy/05-shared-registry-and-usage-mapping.md)
9. [`06-sdlc-coverage-gap-audit.md`](./pipelines/sdlc/06-sdlc-coverage-gap-audit.md)
10. [`06a-sdlc-mandatory-gates-decision.md`](./pipelines/sdlc/06a-sdlc-mandatory-gates-decision.md)
11. [`06b-sdlc-agentic-safety-and-remaining-gates.md`](./pipelines/sdlc/06b-sdlc-agentic-safety-and-remaining-gates.md)
12. [`07-pipeline-contract-standard.md`](./legacy/07-pipeline-contract-standard.md)
13. [`08-sdlc-pipeline-contract.md`](./pipelines/sdlc/08-sdlc-pipeline-contract.md)
14. [`sdlc-stages/`](./pipelines/sdlc/sdlc-stages/README.md) — per-stage prose contracts
15. [`configs/nexus-ai/stages/sdlc/`](../../configs/nexus-ai/stages/sdlc/README.md) — generated machine-readable stage YAMLs
...
| Doc | Title | Holds |
|-----|-------|-------|
| [`00-decision-log.md`](./legacy/00-decision-log.md) | Decision Log | D-001 .. D-010, D-016 |
| [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) | Shared Registry Decision Addendum | D-011 .. D-015 |
...
| 02 | [`02-concept-boundaries.md`](./legacy/02-concept-boundaries.md) | What must NOT be merged (the 7 boundaries) |
| 03 | [`03-governance-and-audit-layering.md`](./legacy/03-governance-and-audit-layering.md) | Governance vs Audit layer separation |
| 04 | [`04-open-discussion-items.md`](./legacy/04-open-discussion-items.md) | Open architecture questions |
| 04a | [`04a-open-discussion-updates.md`](./legacy/04a-open-discussion-updates.md) | Open-items update after registry decision |
| 05 | [`05-shared-registry-and-usage-mapping.md`](./legacy/05-shared-registry-and-usage-mapping.md) | Shared Registry + Usage Mapping rule (all 7 categories) |
| 06 | [`06-sdlc-coverage-gap-audit.md`](./pipelines/sdlc/06-sdlc-coverage-gap-audit.md) | SDLC coverage / gap audit |
| 06a | [`06a-sdlc-mandatory-gates-decision.md`](./pipelines/sdlc/06a-sdlc-mandatory-gates-decision.md) | Three quality areas locked as mandatory/conditional gates |
| 06b | [`06b-sdlc-agentic-safety-and-remaining-gates.md`](./pipelines/sdlc/06b-sdlc-agentic-safety-and-remaining-gates.md) | Agentic-safety + remaining gate families |
| 07 | [`07-pipeline-contract-standard.md`](./legacy/07-pipeline-contract-standard.md) | Reusable pipeline + stage contract standard |
| 08 | [`08-sdlc-pipeline-contract.md`](./pipelines/sdlc/08-sdlc-pipeline-contract.md) | Standard applied to the SDLC Pipeline (first draft) |
...
| # | Doc | Subject | Notes |
|---|-----|---------|-------|
| 01 | [`01-core-definitions.md`](./legacy/01-core-definitions.md) | Core concept definitions | Uses old "AI SDLC Factory" framing |
| 02 | [`02-necessity-and-deduplication.md`](./legacy/02-necessity-and-deduplication.md) | Necessity + de-duplication; "Plugin → removed" | Plugin-cancellation rationale |
| 03 | [`03-skill-semantic-extraction.md`](./legacy/03-skill-semantic-extraction.md) | How skill packages are read/classified before binding | Feeds stage 03 |
| 04 | [`04-team-agent-subagent-model.md`](./legacy/04-team-agent-subagent-model.md) | Team / Team Lead / Agent / Sub-agent model | Lists out-of-scope `plugin_manager_agent` |
| 05 | [`05-pipeline-model.md`](./legacy/05-pipeline-model.md) | Full pipeline model: rework routing, iteration policy, anti-patterns | **Source of `sdlc_pipeline_runtime_rules.yaml`** |
| 06 | [`06-governance-policy-evidence.md`](./legacy/06-governance-policy-evidence.md) | No-human governance: deterministic rules, evidence, trace | Defines `no_plugin_core` policy |
| 07 | [`07-executor-workpackages.md`](./legacy/07-executor-workpackages.md) | Executor work-package definitions (Codex/Claude/Antigravity) | Predecessor of `workpackages/` |
| 08 | [`08-open-discussion-items.md`](./legacy/08-open-discussion-items.md) | Open architecture questions (earlier list) | |

### 1d. Reviews, registry standard, completion (post-contract)

| # | Doc | Subject |
|---|-----|---------|
| 09 | [`09-sdlc-stage-contract-review.md`](./pipelines/sdlc/09-sdlc-stage-contract-review.md) | First consistency review of the stage-contract set |
| 10 | [`10-sdlc-stage-contract-second-review.md`](./pipelines/sdlc/10-sdlc-stage-contract-second-review.md) | Second review: verifies §09 findings closed by `sdlc-stages/06` |
| 11 | [`11-artifact-registry-standard.md`](./legacy/11-artifact-registry-standard.md) | Canonical artifact/evidence naming standard |
| 12 | [`12-completion-review-for-contract-work.md`](./reviews/12-completion-review-for-contract-work.md) | Completion review of the contract work |
| — | [`README-updates-after-contract-work.md`](./legacy/README-updates-after-contract-work.md) | Canonical index addendum (09–12, configs, stage prose, workpackages) |
...
[`sdlc-stages/README.md`](./pipelines/sdlc/sdlc-stages/README.md).

| File | Phase | Stages covered |
|------|-------|----------------|
| [`sdlc-stages/01-foundation-and-requirements.md`](./pipelines/sdlc/sdlc-stages/01-foundation-and-requirements.md) | Foundation & Requirements | intake, domain_risk_profile, skill_semantic_extraction, requirements, requirements_review |
| [`sdlc-stages/02-design-risk-and-planning.md`](./pipelines/sdlc/sdlc-stages/02-design-risk-and-planning.md) | Design, Risk & Planning | architecture, architecture_review, security_privacy_design, premortem_fmea, planning |
| [`sdlc-stages/03-build-review-and-test.md`](./pipelines/sdlc/sdlc-stages/03-build-review-and-test.md) | Build, Review & Test | implementation, code_review, test_generation, test_execution, verification_loop_bug_finding |
| [`sdlc-stages/04-validation-and-product-gates.md`](./pipelines/sdlc/sdlc-stages/04-validation-and-product-gates.md) | Validation & Product Gates | security_validation, supply_chain_sbom_license, ai_agent_safety_evaluation, privacy_data_lifecycle, api_contract, data_migration, accessibility_ux, performance_resilience, cost_resource, backup_restore_dr |
| [`sdlc-stages/05-completion-release-and-learning.md`](./pipelines/sdlc/sdlc-stages/05-completion-release-and-learning.md) | Completion, Release & Learning | operations_readiness, evidence_graph_build, development_completion, release_candidate, refraction_learning |
| [`sdlc-stages/06-canonical-corrections-and-overrides.md`](./pipelines/sdlc/sdlc-stages/06-canonical-corrections-and-overrides.md) | Corrections | Canonical overrides that close §09 review findings (cited by YAML headers) |
...
[`README-updates-after-roadmap-plans.md`](./legacy/README-updates-after-roadmap-plans.md). Execution order
is 13 → 22; `22` is the stop-rule doc that ends the planning series.

| # | Doc | Subject |
|---|-----|---------|
| 13 | [`13-sdlc-completion-full-execution-plan.md`](./workpackages/13-sdlc-completion-full-execution-plan.md) | Full plan to take SDLC from design-ready to contract-ready + reviewed |
| 14 | [`14-post-sdlc-continuation-plan.md`](./legacy/14-post-sdlc-continuation-plan.md) | Work after SDLC completion |
| 15 | [`15-master-roadmap-and-dependency-map.md`](./legacy/15-master-roadmap-and-dependency-map.md) | Master roadmap + dependency map |
| 16 | [`16-pipeline-catalog-expansion-plan.md`](./legacy/16-pipeline-catalog-expansion-plan.md) | Cataloguing non-SDLC pipeline types |
| 17 | [`17-shared-registry-formalization-plan.md`](./legacy/17-shared-registry-formalization-plan.md) | Make the Shared Registry machine-readable |
| 18 | [`18-team-agent-subagent-catalog-plan.md`](./legacy/18-team-agent-subagent-catalog-plan.md) | Team / Agent / Sub-agent catalogues |
| 19 | [`19-governance-audit-readiness-plan.md`](./legacy/19-governance-audit-readiness-plan.md) | Governance + Audit implementation readiness |
| 20 | [`20-executor-workflow-standard-plan.md`](./legacy/20-executor-workflow-standard-plan.md) | Executor workflow standard |
| 21 | [`21-runtime-refactor-planning-only-plan.md`](./legacy/21-runtime-refactor-planning-only-plan.md) | Planning-only rule before any runtime/refactor |
| 22 | [`22-final-stop-rule-and-readiness-gate.md`](./legacy/22-final-stop-rule-and-readiness-gate.md) | Final stop rule + readiness gate (ends the planning series) |
...
| [`diagrams/sdlc-pipeline-flow.mmd`](./pipelines/sdlc/diagrams/sdlc-pipeline-flow.mmd) | 31-stage SDLC pipeline flow: on_pass backbone + main rework routes (owners per stage YAMLs) |
| [`diagrams/shared-registry-usage-map.mmd`](./legacy/diagrams/shared-registry-usage-map.mmd) | Shared Registry + Usage Mapping across the 7 shared categories |
| [`diagrams/governance-audit-layering.mmd`](./legacy/diagrams/governance-audit-layering.mmd) | Governance vs Audit layering (Governance != Audit; Evidence != Trace) |

---

## 10. Persisted memory (`.memory/`) and repo note

- [`.memory/`](../../.memory/README.md) holds the session memory the context-lock report reviewed:
...
|----------|-------------------|-----------|
| D-001 | Top structure is **Nexus AI Orchestration Model**; SDLC is one pipeline, not the top (NOT "AI SDLC Factory"). | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-002 | **Plugin cancelled** — not in core scope; core concepts are Pipeline/Team/Team Lead/Agent/Sub-agent/Core Ability/Skill/Tool/Governance/Audit/Evidence/Trace. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-003 | **Core Abilities** = Supervisor, Coder, Vision, Audio, Creative, Memory, Web, OS — these names are no longer called agents. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-004 | Core Abilities are **not** members of any team; they are Nexus AI's shared capability layer, each with its own model/engine/config. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-005 | **Team hierarchy:** Team → Team Lead → Agents → Sub-agents (and direct sub-agents). | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-006 | **Supervisor != SDLC Team Lead.** Supervisor is a Core Ability; SDLC Team Lead is the role running the SDLC team/run. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-007 | **Governance is not blind-merged** — Global/Pipeline/Team/Stage/Core Ability/Skill/Tool governance layers stay distinct. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-008 | **Audit is not blind-merged** — Evidence (decision proof) != Trace (process history); both under Audit but kept separate. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-009 | **Pipeline != Pipeline Run** — definition/template vs the actual executed instance. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-010 | **Pipelines are plural** under Nexus AI (SDLC, Research, Activation, Operations, …). | [`00-decision-log.md`](./legacy/00-decision-log.md) |
| D-011 | **Shared Registry != Usage Mapping** — "what exists" vs "who/which pipeline/stage/agent uses it"; the repeat is a usage relationship, not ownership. | [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) |
| D-012 | The Shared-Registry-+-Usage-Mapping rule applies to **all 7 shared categories** (Core Abilities, Skills, Tools, Governance Profiles, Audit Schemas, Model/Provider Profiles, Context/Memory Profiles). | [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) |
| D-013 | In the main hierarchy a **Skill appears by name only**; skill package contents live in the skill inventory/audit doc. | [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) |
| D-014 | **Core Ability sub-operations appear separately as Tools** (Skill != Tool); the Core Ability name is in the registry, its callable ops are in the Tool registry + usage mapping. | [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) |
| D-015 | **Model/Provider and Context/Memory profiles must be visible** in both the Shared Registry and the usage context. | [`00a-shared-registry-decisions.md`](./legacy/00a-shared-registry-decisions.md) |
| D-016 | **Canonical always-required SDLC gate set** — 19 always gates = doc 06 §8 base ∪ 06a ∪ 06b (incl. `risk_register_reviewed`, `performance_resilience_pass_or_accepted`, `agentic_safety_eval_pass`); doc 06 §8 = doc 08 §4 = `sdlc_pipeline.yaml` `required_gates.always`. | [`00-decision-log.md`](./legacy/00-decision-log.md) |
