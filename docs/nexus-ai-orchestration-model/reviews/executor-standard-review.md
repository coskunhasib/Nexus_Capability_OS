...
- **Scope reviewed:** the executor-standard layer — five files under
  [`../executor-standard/`](../legacy/executor-standard/README.md):
...
- **Canonical sources checked against:**
  [`../20-executor-workflow-standard-plan.md`](../legacy/20-executor-workflow-standard-plan.md) (the
  ...
  [`../13-sdlc-completion-full-execution-plan.md`](../workpackages/13-sdlc-completion-full-execution-plan.md)
