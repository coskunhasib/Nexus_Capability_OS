...
- **Canonical sources:** doc 20 (executor standard), [`../13-sdlc-completion-full-execution-plan.md`](../../workpackages/13-sdlc-completion-full-execution-plan.md) (the worked example), [`../22-final-stop-rule-and-readiness-gate.md`](../22-final-stop-rule-and-readiness-gate.md) (the readiness gate)
...
> [`../reviews/`](../../../ai-sdlc-factory/reviews).
...
- **Required review verdicts** (doc 22 §5) — the named reviews under [`../reviews/`](../../../ai-sdlc-factory/reviews)
...
|-------|-----------------------------|---------------------------|
| Context lock | [`../execution/phase-0-context-lock-report.md`](../../reviews/phase-0-context-lock-report.md) | — |
