...
- **Phase:** G/H — the doc 21 §10 review handoff for the runtime/refactor planning-only plan set
  ...
  [`../22-final-stop-rule-and-readiness-gate.md`](../22-final-stop-rule-and-readiness-gate.md) §5).
- **Scope:** all documents under
  [`../runtime-refactor-plan/`](../runtime-refactor-plan/) — the overview `README.md` plus the **ten**
...
**F-1 (MINOR, doc hygiene).** [`../BLUEPRINT_INDEX.md`](../BLUEPRINT_INDEX.md) currently has only a
...
[`../executor-standard/README.md`](../executor-standard/README.md)). It assesses the runtime/refactor
