...
- **Phase:** G/H — [`../21-runtime-refactor-planning-only-plan.md`](../21-runtime-refactor-planning-only-plan.md) §7 ("Pipeline runner plan requirements")
...
| **31 stage contracts** | [`../../../configs/nexus-ai/stages/sdlc/*.yaml`](../../../configs/nexus-ai/stages/sdlc/) | Per-stage `gates`, `on_pass`, `on_fail`, `rework_route`, `blocking_conditions`, `optional_conditions`, `conditional_required_gates`, `applicability_decision` (conditional stages), `max_iterations`, and the per-stage `uses_*` bindings. |
...
| **Pipeline contract standard** | [`../07-pipeline-contract-standard.md`](../07-pipeline-contract-standard.md), [`../08-sdlc-pipeline-contract.md`](../08-sdlc-pipeline-contract.md) | §2 definition fields, §3 run fields, §4 stage-contract fields; doc 08 §4 mandatory + conditional gates, §6 development-completion aggregation, §7 release-candidate gating. |
| **Pipeline model** | [`../05-pipeline-model.md`](../05-pipeline-model.md) | §5 rework routing, §6 iteration policy, §7 anti-patterns — the source the runtime-rules file formalizes. |
| **Executor / owner boundary** | [`../executor-standard/README.md`](../executor-standard/README.md), [`../22-final-stop-rule-and-readiness-gate.md`](../22-final-stop-rule-and-readiness-gate.md) | The owner-approval gate that must clear before this plan becomes implementation ([§11](#11-owner-approval-dependency-explicit)). |
