...
- **Phase:** G/H (doc 21 — [`../21-runtime-refactor-planning-only-plan.md`](../21-runtime-refactor-planning-only-plan.md) §4 "Shared registry loader plan"; §5 required output `runtime-refactor-plan/shared-registry-loader-plan.md`).
- **Builds on (canonical sources, read from disk):**
  - The Shared-Registry + Usage-Mapping rule — [`../05-shared-registry-and-usage-mapping.md`](../05-shared-registry-and-usage-mapping.md); decisions D-011..D-015 in [`../00a-shared-registry-decisions.md`](../00a-shared-registry-decisions.md).
  - The registry item contract + per-category fields + validation rule — [`../17-shared-registry-formalization-plan.md`](../17-shared-registry-formalization-plan.md) §3/§4/§11/§13.
  ...
  - Canonical governance policy ids — [`../06-governance-policy-evidence.md`](../06-governance-policy-evidence.md) §2–§3 (`no_self_approval`, `evidence_required`, …); operating model [`../01-nexus-ai-operating-model.md`](../01-nexus-ai-operating-model.md) §6 (the 8 abilities).
