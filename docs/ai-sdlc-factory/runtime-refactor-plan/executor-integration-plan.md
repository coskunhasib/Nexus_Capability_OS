...
- **Phase:** G/H (runtime/refactor PLANNING). Realizes the tenth planning area in
  [`../21-runtime-refactor-planning-only-plan.md`](../21-runtime-refactor-planning-only-plan.md) §4
...
([`../executor-standard/README.md`](../executor-standard/README.md), and the per-executor profiles
...
([`../executor-standard/README.md`](../executor-standard/README.md) §2) and the team/agent model
([`../04-team-agent-subagent-model.md`](../04-team-agent-subagent-model.md);
[`../00-decision-log.md`](../00-decision-log.md) K-005).
...
| Defined by | [`../executor-standard/`](../executor-standard/) (the workflow standard + per-executor profiles). | [`../../../configs/nexus-ai/agent_roles.yaml`](../../../configs/nexus-ai/agent_roles.yaml), under a `team_lead` in [`../../../configs/nexus-ai/team_templates.yaml`](../../../configs/nexus-ai/team_templates.yaml). |
...
1. **The executor workflow standard** — [`../executor-standard/README.md`](../executor-standard/README.md)
   ...
   [`../executor-standard/claude-code.md`](../executor-standard/claude-code.md),
   [`../executor-standard/codex.md`](../executor-standard/codex.md),
   [`../executor-standard/antigravity.md`](../executor-standard/antigravity.md). This is the rule
...
4. **The readiness gate** — [`../22-final-stop-rule-and-readiness-gate.md`](../22-final-stop-rule-and-readiness-gate.md)
...
2. **Load mandatory context + lock check.** The executor loads `mandatory_context` and
   ...
   [`../execution/phase-0-context-lock-report.md`](../execution/phase-0-context-lock-report.md)
   pattern.
...
|---|---|---|
| **Claude Code** | [`../executor-standard/claude-code.md`](../executor-standard/claude-code.md) | Primary implementer of component logic, refactor edits, and the accompanying docs/tests — the same primary-executor role it held for Phases A–E, now producing code instead of contracts. |
| **Codex** | [`../executor-standard/codex.md`](../executor-standard/codex.md) | Repo-oriented contract/schema generation and **static validation** for the runtime config surface (schemas the runner/governance/audit components consume). *Codex generates and checks contracts; it does not run them* — and validation stays static, never pipeline execution. |
| **Antigravity** | [`../executor-standard/antigravity.md`](../executor-standard/antigravity.md) | Assembly, diagrams, and the traceability overview kept in sync as the runtime takes shape — a **view** over the implemented system, never new contract semantics. |
...
[`../executor-standard/README.md`](../executor-standard/README.md) §7 and the per-executor profiles'
worked examples):
...
- ChatGPT reviewed (the corpus under [`../reviews/`](../reviews/)); **no** executor wrote to `main`,
...
This plan is gated. Per [`../21-runtime-refactor-planning-only-plan.md`](../21-runtime-refactor-planning-only-plan.md)
§2/§10/§11 and [`../22-final-stop-rule-and-readiness-gate.md`](../22-final-stop-rule-and-readiness-gate.md)
...
1. **Producing this plan is allowed now.** It is a planning-only document and changes no code. It is
   ...
   ([`../executor-standard/README.md`](../executor-standard/README.md) §1).
