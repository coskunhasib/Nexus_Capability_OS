...
- **Phase:** G/H — the first of the doc 21 §5 runtime/refactor plan documents
  ([`../21-runtime-refactor-planning-only-plan.md`](../21-runtime-refactor-planning-only-plan.md),
...
| [`../21-runtime-refactor-planning-only-plan.md`](../21-runtime-refactor-planning-only-plan.md) | Mandate (§5 required output #2; §6 requirements; §3 non-goals; §10 review handoff). |
| [`../22-final-stop-rule-and-readiness-gate.md`](../22-final-stop-rule-and-readiness-gate.md) | Hard blockers (§6), owner-decision format (§7), prohibitions until approval (§9). |
...
| [`../03-governance-and-audit-layering.md`](../03-governance-and-audit-layering.md) | §7 Core Ability Governance profile names; §10–12 the Evidence/Trace separation the audit references must preserve. |
| [`../06-governance-policy-evidence.md`](../06-governance-policy-evidence.md) | Canonical policy ids (`no_self_approval`, `evidence_required`, `no_secret_read`, `no_silent_mutation`, `no_policy_bypass`, `no_destructive_action_without_gate`) referenced by the abilities. |
| [`../17-shared-registry-formalization-plan.md`](../17-shared-registry-formalization-plan.md) | §3 item contract + §4 category fields + §11/§13 status & usage-mapping rules that shape the alignment model (§3). |
...
([`../20-executor-workflow-standard-plan.md`](../20-executor-workflow-standard-plan.md)). It does
